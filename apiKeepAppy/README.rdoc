...
* heroku open
               ...
               Prefix Verb     URI Pattern                            Controller#Action
                signup GET|POST /signup(.:format)                      users#create
                 login GET|POST /login(.:format)                       sessions#login_attempt
                logout GET|POST /logout(.:format)                      sessions#logout
     ...
     api_v1_publicfeed GET      /api/v1/publicfeeds/:id(.:format)      api/v1/publicfeeds#show {:format=>"json"}
          ...
          edit_article GET      /articles/:id/edit(.:format)           articles#edit
               article GET      /articles/:id(.:format)                articles#show
                 ...
                 users GET      /users/create(.:format)                users#create
