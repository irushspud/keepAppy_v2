...
.factory('ArticlesService', ['$resource', function($resource){
  return $resource('http://localhost:3000/api/v1/articles', {}, {
...
.factory('PublicFeed', ['$resource', function($resource){
  return $resource('http://localhost:3000/api/v1/publicfeeds', {}, {
...
.factory('GetQustions', ['$resource', function($resource){
  return {
    ...
    article: $resource('http://localhost:3000/api/v1/articles', {}, { get: { method: 'GET', params: {tag: '@tag'}, isArray: true }}),
    quote: $resource('http://localhost:3000/api/v1/quotes', {}, { get: { method: 'GET', isArray: true }})
  };
}])
